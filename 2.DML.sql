...
insert into PokemonType (Nome) values ('Fogo'), ('Água'), ('Planta'), ('Venenoso'), ('Voador'), ('Metal'), ('Fantasma'), ('Sombrio'), ('Pedra'), ('Elétrico'), ('Fada'), ('Dragão'), ('Lutador'), ('Inseto'), ('Gelo'), ('Terrestre'), ('Psíquico'), ('Normal')
