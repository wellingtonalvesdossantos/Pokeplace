...
(
	...
	CONSTRAINT UK_Trainer_Apelido UNIQUE ([Apelido]),
	CONSTRAINT UK_Trainer_Codigo UNIQUE ([Codigo]),
...
(
	...
	CONSTRAINT UK_RaidMember UNIQUE ([RaidId],[TrainerId]),
